...
// Cross Module References
	...
	UNREALDELEGATE_API UClass* Z_Construct_UClass_UStudent();
	UNREALDELEGATE_API UClass* Z_Construct_UClass_UStudent_NoRegister();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UStudent_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UStudent_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_ULessonInterface_NoRegister, (int32)VTABLE_OFFSET(UStudent, ILessonInterface), false },  // 3373378245
		};
	...
	template<> UNREALDELEGATE_API UClass* StaticClass<UStudent>()
	{
		return UStudent::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UStudent);
	UStudent::~UStudent() {}
	struct Z_CompiledInDeferFile_FID_UnrealDelegate_Source_UnrealDelegate_Student_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealDelegate_Source_UnrealDelegate_Student_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UStudent, UStudent::StaticClass, TEXT("UStudent"), &Z_Registration_Info_UClass_UStudent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStudent), 1652172148U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealDelegate_Source_UnrealDelegate_Student_h_2393848820(TEXT("/Script/UnrealDelegate"),
		Z_CompiledInDeferFile_FID_UnrealDelegate_Source_UnrealDelegate_Student_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealDelegate_Source_UnrealDelegate_Student_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
