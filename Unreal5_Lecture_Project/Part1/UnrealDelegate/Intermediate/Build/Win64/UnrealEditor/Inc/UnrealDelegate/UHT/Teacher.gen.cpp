...
// Cross Module References
	...
	UNREALDELEGATE_API UClass* Z_Construct_UClass_UTeacher();
	UNREALDELEGATE_API UClass* Z_Construct_UClass_UTeacher_NoRegister();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTeacher_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UTeacher_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_ULessonInterface_NoRegister, (int32)VTABLE_OFFSET(UTeacher, ILessonInterface), false },  // 3373378245
		};
	...
	template<> UNREALDELEGATE_API UClass* StaticClass<UTeacher>()
	{
		return UTeacher::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UTeacher);
	UTeacher::~UTeacher() {}
	struct Z_CompiledInDeferFile_FID_UnrealDelegate_Source_UnrealDelegate_Teacher_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealDelegate_Source_UnrealDelegate_Teacher_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTeacher, UTeacher::StaticClass, TEXT("UTeacher"), &Z_Registration_Info_UClass_UTeacher, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTeacher), 2352078194U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealDelegate_Source_UnrealDelegate_Teacher_h_487574307(TEXT("/Script/UnrealDelegate"),
		Z_CompiledInDeferFile_FID_UnrealDelegate_Source_UnrealDelegate_Teacher_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealDelegate_Source_UnrealDelegate_Teacher_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
