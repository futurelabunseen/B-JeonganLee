...
// Cross Module References
	...
	OBJECTREFLECTION_API UClass* Z_Construct_UClass_UMyGameInstance();
	OBJECTREFLECTION_API UClass* Z_Construct_UClass_UMyGameInstance_NoRegister();
...
// End Cross Module References
	...
	template<> OBJECTREFLECTION_API UClass* StaticClass<UMyGameInstance>()
	{
		return UMyGameInstance::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMyGameInstance);
	UMyGameInstance::~UMyGameInstance() {}
	struct Z_CompiledInDeferFile_FID_ObjectReflection_Source_ObjectReflection_MyGameInstance_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ObjectReflection_Source_ObjectReflection_MyGameInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMyGameInstance, UMyGameInstance::StaticClass, TEXT("UMyGameInstance"), &Z_Registration_Info_UClass_UMyGameInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMyGameInstance), 3296992881U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ObjectReflection_Source_ObjectReflection_MyGameInstance_h_3760596763(TEXT("/Script/ObjectReflection"),
		Z_CompiledInDeferFile_FID_ObjectReflection_Source_ObjectReflection_MyGameInstance_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ObjectReflection_Source_ObjectReflection_MyGameInstance_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
