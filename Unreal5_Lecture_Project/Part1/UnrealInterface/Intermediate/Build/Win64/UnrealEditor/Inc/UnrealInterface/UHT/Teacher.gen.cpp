...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTeacher_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UTeacher_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_ULessonInterface_NoRegister, (int32)VTABLE_OFFSET(UTeacher, ILessonInterface), false },  // 3163460514
		};
	...
	UTeacher::~UTeacher() {}
	struct Z_CompiledInDeferFile_FID_UnrealInterface_Source_UnrealInterface_Teacher_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealInterface_Source_UnrealInterface_Teacher_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTeacher, UTeacher::StaticClass, TEXT("UTeacher"), &Z_Registration_Info_UClass_UTeacher, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTeacher), 940055257U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealInterface_Source_UnrealInterface_Teacher_h_1112994562(TEXT("/Script/UnrealInterface"),
		Z_CompiledInDeferFile_FID_UnrealInterface_Source_UnrealInterface_Teacher_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealInterface_Source_UnrealInterface_Teacher_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
