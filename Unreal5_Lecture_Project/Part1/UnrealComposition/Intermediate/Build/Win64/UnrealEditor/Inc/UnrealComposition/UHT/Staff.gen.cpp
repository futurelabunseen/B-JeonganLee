...
// Cross Module References
	...
	UNREALCOMPOSITION_API UClass* Z_Construct_UClass_UStaff();
	UNREALCOMPOSITION_API UClass* Z_Construct_UClass_UStaff_NoRegister();
...
// End Cross Module References
	...
	template<> UNREALCOMPOSITION_API UClass* StaticClass<UStaff>()
	{
		return UStaff::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UStaff);
	UStaff::~UStaff() {}
	struct Z_CompiledInDeferFile_FID_UnrealComposition_Source_UnrealComposition_Staff_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealComposition_Source_UnrealComposition_Staff_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UStaff, UStaff::StaticClass, TEXT("UStaff"), &Z_Registration_Info_UClass_UStaff, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStaff), 2821163356U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealComposition_Source_UnrealComposition_Staff_h_3797281818(TEXT("/Script/UnrealComposition"),
		Z_CompiledInDeferFile_FID_UnrealComposition_Source_UnrealComposition_Staff_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealComposition_Source_UnrealComposition_Staff_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
