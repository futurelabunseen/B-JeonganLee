...
protected:
	...
	// Fight Section
protected:
	// TSubclassOf는 사용할 클래스를 한정할 수 있다
	// 해당 클래스 기준으로 한정 짓기에 자식까지만 가능함
...
protected:
	...
	// TSubclassOf 좀 더 쉽게 다형성이 발생하는 구간에서 참조의 범위를 좁힘

	UPROPERTY(VisibleAnywhere, Category = Reward, Meta = (AllowPrivateAccess = "true"))
	TArray<TWeakObjectPtr<class AABItemBox>> RewardBoxes;
	// TWeakObjectPtr는 약참조로 무관하지만 관리를 해야할 때,
	// 즉, 맵에는 존재하지만 로직 자체는 상자 스스로 관리하니, 삭제가 되어도 관리되지 않도록
	// 약참조로 관리
