...
#include "UGAT_JumpAndWaitForLanding.generated.h"
 ...
 */
UCLASS()
class UUGAT_JumpAndWaitForLanding : public UAbilityTask
{
	GENERATED_BODY()

public:
	UUGAT_JumpAndWaitForLanding();
	...
	static UUGAT_JumpAndWaitForLanding* CreateTask(UGameplayAbility* OwningAbility);
